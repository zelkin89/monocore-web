                ...
                <div className="flex-1 overflow-y-auto p-6 sm:p-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6 font-mono text-sm">
                        ...
                        <div className="space-y-2">
                            ...
                            <input required type="text" placeholder="Inserisci il tuo nome..." className="w-full bg-transparent border-b border-white/10 py-2 text-industrial focus:border-brand-orange focus:outline-none transition-colors rounded-none placeholder:text-white/10" />
                        </div>

                        <div className="space-y-2">
                            <label className="text-industrial/40 text-[10px] uppercase tracking-widest block">02. Email</label>
                            <input required type="email" placeholder="nome@azienda.it" className="w-full bg-transparent border-b border-white/10 py-2 text-industrial focus:border-brand-orange focus:outline-none transition-colors rounded-none placeholder:text-white/10" />
                        </div>

                        <div className="space-y-2">
                            <label className="text-industrial/40 text-[10px] uppercase tracking-widest block">03. Telefono</label>
                            <input required type="tel" placeholder="+39 ..." className="w-full bg-transparent border-b border-white/10 py-2 text-industrial focus:border-brand-orange focus:outline-none transition-colors rounded-none placeholder:text-white/10" />
                        </div>

                        <div className="space-y-2">
                            <label className="text-industrial/40 text-[10px] uppercase tracking-widest block">04. Nome Azienda</label>
                            <input required type="text" placeholder="Azienda S.R.L." className="w-full bg-transparent border-b border-white/10 py-2 text-industrial focus:border-brand-orange focus:outline-none transition-colors rounded-none placeholder:text-white/10" />
                        </div>

                        <div className="space-y-2">
                            <label className="text-industrial/40 text-[10px] uppercase tracking-widest block">05. Sito Web</label>
                            <input required type="text" inputMode="url" placeholder="www.azienda.it" className="w-full bg-transparent border-b border-white/10 py-2 text-industrial focus:border-brand-orange focus:outline-none transition-colors rounded-none placeholder:text-white/10" />
                        </div>

                        <div className="space-y-2">
                            <label className="text-industrial/40 text-[10px] uppercase tracking-widest block">06. Fatturato Aziendale</label>
                            <select required className="w-full bg-void border-b border-white/10 py-2 text-industrial focus:border-brand-orange focus:outline-none transition-colors rounded-none appearance-none cursor-pointer">
                        ...
                        <div className="space-y-2">
                            ...
                            <input required type="text" placeholder="Es. Consulenza, Marketing, Logistica..." className="w-full bg-transparent border-b border-white/10 py-2 text-industrial focus:border-brand-orange focus:outline-none transition-colors rounded-none placeholder:text-white/10" />
                        </div>
                        ...
                        <button type="submit" className="w-full bg-industrial text-void font-bold font-sans uppercase py-4 hover:bg-brand-orange transition-colors rounded-sm tracking-widest text-lg">
                            INIZIA ANALISI
                        </button>
                    </form>
                </div>
